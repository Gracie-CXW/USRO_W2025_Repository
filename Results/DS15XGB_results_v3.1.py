...
Dataset['S'] = np.log10(Dataset['S']) #Taking log10 of Selectivity - as specified in paper
x = Dataset[['name','PLD','LCD','θ','ASA','ρ','POAV','MNC','MC','Metal-to-O','Metal-to-C','NSP','NSP-to-C','N-to-C']]
y = Dataset['S']

good = Dataset[Dataset['name'].isin(good_names)]
bad = Dataset[Dataset['name'].isin(bad_names)]

good_x = good[['name','PLD','LCD','θ','ASA','ρ','POAV','MNC','MC','Metal-to-O','Metal-to-C','NSP','NSP-to-C','N-to-C']]
good_y = good['S']

bad_x = bad[['name','PLD','LCD','θ','ASA','ρ','POAV','MNC','MC','Metal-to-O','Metal-to-C','NSP','NSP-to-C','N-to-C']]
bad_y = bad['S']
...
output1 = r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\train_bad.txt"
output2 = r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\train_good.txt"
output3= r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\train_mixed.txt"
...
def train_bad(datasets,output):
    ...
    for dataset in datasets:
        if dataset == 'bad':
            ...
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\Correlation_Plots\bad_bad.png")
            plt.close()
            ...
            text = f'R2: {r2:.4f} \n RMSE: {Decimal(rmse):.2E} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\Correlation_Plots\bad_good.png")
            plt.close()
            ...
            test_x = pd.concat([test_x_bad,test_good[['name','PLD','LCD','θ','ASA','ρ','POAV','MNC','MC','Metal-to-O','Metal-to-C','NSP','NSP-to-C','N-to-C']]])
            ...
            text = f'R2: {r2:.4f} \n RMSE: {Decimal(rmse):.2E} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70, y=max_y*0.10, s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\Correlation_Plots\bad_mixed.png")
            plt.close()
...
def train_good(datasets,output):
    ...
    for dataset in datasets:
        if dataset == 'good':
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\Correlation_Plots\good_good.png")
            plt.close()
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\Correlation_Plots\good_bad.png")
            plt.close()
            ...
            test_x = pd.concat([test_x_good,badset[['name','PLD','LCD','θ','ASA','ρ','POAV','MNC','MC','Metal-to-O','Metal-to-C','NSP','NSP-to-C','N-to-C']]])
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\Correlation_Plots\good_mixed.png")
            plt.close()
...
def train_mixed(datasets,output):
    ...
    for dataset in datasets:
        if dataset == 'mixed':
            ...
            mixed_x = mixed[['name','PLD','LCD','θ','ASA','ρ','POAV','MNC','MC','Metal-to-O','Metal-to-C','NSP','NSP-to-C','N-to-C']]
            mixed_y = mixed['S']
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\Correlation_Plots\mixed_mixed.png")
            plt.close()
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\Correlation_Plots\mixed_good.png")
            plt.close()
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\XGB\Correlation_Plots\mixed_bad.png")
            plt.close()
...
train_bad(tests,output1)
train_good(tests,output2)
train_mixed(tests,output3)