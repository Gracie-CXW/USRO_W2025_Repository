...
x = Dataset.drop(columns=['OMS type','S','CO2 loading','CO loading'])
y = Dataset['S']

good = Dataset[Dataset['name'].isin(good_names)]
bad = Dataset[Dataset['name'].isin(bad_names)]

good_x = good.drop(columns=['OMS type','S','CO2 loading','CO loading'])
good_y = good['S']

bad_x = bad.drop(columns=['OMS type','S','CO2 loading','CO loading'])
bad_y = bad['S']

def RFR(train_x,test_x,train_y,test_y):
    train_x = train_x 
    test_x = test_x 
    train_y = train_y 
    test_y = test_y 

    # Scaling - paper did not specify scaling of features
    '''
...
pred_y,r2,rmse,mape = RFR(
    train_x.drop(columns=['name']),
    test_x.drop(columns=['name']),train_y,test_y)
print(r2,rmse,mape)
sys.exit()

tests = ['bad','good','mixed']
output1 = r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\train_bad.txt"
output2 = r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\train_good.txt"
output3 = r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\train_mixed.txt"
...
def train_bad(datasets,output):
    ...
    for dataset in datasets:
        if dataset == 'bad':
            ...
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\Correlation_Plots\bad_bad.png")
            plt.close()
            ...
            text = f'R2: {r2:.4f} \n RMSE: {Decimal(rmse):.2E} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\Correlation_Plots\bad_good.png")
            plt.close()
            ...
            test_x = pd.concat([test_x_bad,test_good.drop(columns=['OMS type','S','CO2 loading','CO loading'])])
            ...
            text = f'R2: {r2:.4f} \n RMSE: {Decimal(rmse):.2E} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70, y=max_y*0.10, s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\Correlation_Plots\bad_mixed.png")
            plt.close()
...
def train_good(datasets,output):
    ...
    for dataset in datasets:
        if dataset == 'good':
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\Correlation_Plots\good_good.png")
            plt.close()
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\Correlation_Plots\good_bad.png")
            plt.close()
            ...
            test_x = pd.concat([test_x_good,badset.drop(columns=['OMS type','S','CO2 loading','CO loading'])])
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\Correlation_Plots\good_mixed")
            plt.close()
...
def train_mixed(datasets,output):
    ...
    for dataset in datasets:
        if dataset == 'mixed':
            ...
            mixed_x = mixed.drop(columns=['OMS type','S','CO2 loading','CO loading'])
            mixed_y = mixed['S']
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\Correlation_Plots\mixed_mixed.png")
            plt.close()
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\Correlation_Plots\mixed_good.png")
            plt.close()
            ...
            text = f'R2: {r2:.4f} \n RMSE: {rmse:.4f} \n MAPE: {mape:.3f} \n Train Size: {len(train_x)} \n Test Size: {len(test_x)}'
            plt.text(x=max_y*0.70,y=max_y*0.10,s=text)
            plt.savefig(r"C:\Users\Grace\Documents\Code\USRO 2025W\My Code\DS15_data\RFR\Correlation_Plots\mixed_bad.png")
            plt.close()
