...
ps_fp = r"/share_scratch/gwang/USRO_25W/DS22rawdata/ps_usable_hydrogen_storage_capacity_gcmcv2.xlsx"
tps_fp = r"/share_scratch/gwang/USRO_25W/DS22rawdata/tps_usable_hydrogen_storage_capacity_gcmcv2.xlsx"
...
def GBR_search(X,y):
    ...
    parameters = {
        ...
        'min_samples_split':np.arange(10,200,20),
...
def RF_search(X,y):
    ...
    parameters = {
        'n_estimators':np.arange(100,2100,500),
...
print(
    'UG/PS params: ', RF_search(ugps_x,ugps), '\n',
    'UV/PS params: ', RF_search(uvps_x,uvps),'\n',
    'UG/TPS params: ', RF_search(ugtps_x,ugtps),'\n',
    'UV/TPS params: ', RF_search(uvtps_x,uvtps)
)
